    ...
    public partial class snakeForm : Form
    {
        ...
        private void pbCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Brush snake_color = i == 0 ? Brushes.Orange : Brushes.Black;
                    canvas.FillRectangle(snake_color, new Rectangle(snake[i].X * tile_width, snake[i].Y * tile_height, tile_width, tile_height));
                }
                canvas.FillRectangle(Brushes.Brown, new Rectangle(food_piece.X * tile_width, food_piece.Y * tile_height, tile_width, tile_height));
